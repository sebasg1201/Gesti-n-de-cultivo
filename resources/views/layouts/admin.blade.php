    ...
    <div class="flex min-h-screen">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                ...
                <div class="space-y-1">
                    <button onclick="toggleAccordion('gestion-menu')"
                        ...
                        <svg id="arrow-gestion-menu" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 transition-transform duration-200 shrink-0 {{ $gestionActive ? 'rotate-180' : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div id="gestion-menu" class="{{ $gestionActive ? 'block' : 'hidden' }} pl-4 space-y-1 overflow-hidden transition-all duration-300">
                        ...
                        <a href="{{ route('admin.usuarios.index') }}" class="group flex items-center gap-3 px-4 py-2 rounded-lg text-sm transition-all duration-200 {{ active('admin.usuarios.*') }}">
                            <div class="w-1 h-1 bg-emerald-400 rounded-full shrink-0"></div>
        ...
        <div class="flex-1 min-w-0 flex flex-col min-h-screen">
            ...
            <header class="relative z-50">
                ...
                <!-- Fondo -->
                <div class="absolute inset-0 bg-gradient-to-r from-emerald-600 via-green-500 to-emerald-600 opacity-90 shadow-lg"></div>
                ...
                <div class="relative px-6 lg:px-12 py-6 lg:py-8 flex justify-between items-center text-white">
                    ...
                    <div class="flex items-center gap-4 lg:gap-6">
                        ...
                        <!-- Fecha -->
                        <div class="hidden md:flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl text-sm">
                        ...
                        <div class="relative group">
                            ...
                            <div class="flex items-center gap-3 lg:gap-4 bg-white text-gray-800 px-3 lg:px-5 py-2 lg:py-3 rounded-xl lg:rounded-2xl shadow-xl hover:scale-[1.02] transition-all duration-300 cursor-pointer">

                                <div class="w-8 h-8 lg:w-11 lg:h-11 rounded-lg lg:rounded-xl bg-gradient-to-tr from-emerald-500 to-green-600 text-white flex items-center justify-center font-bold shadow-md">
            ...
            <main class="p-4 lg:p-8 flex-1 min-w-0">
                ...
                <div class="bg-white rounded-2xl lg:rounded-3xl shadow-2xl p-4 lg:p-8 border border-emerald-100 min-h-[70vh]">
