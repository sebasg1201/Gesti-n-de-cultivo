                                    ...
                                    <tr class="group hover:bg-emerald-50/30 transition-colors">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap">
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-bold text-slate-700 leading-none">{{ $empresa->nombre_repre_legal ?? 'N/A' }}</span>
                                                <span
                                                    class="text-[11px] font-medium text-slate-400 mt-1 italic">{{ $empresa->correo ?? 'N/A' }}</span>
                                            </div>
                                        </td>
