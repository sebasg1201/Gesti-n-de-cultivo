...
@section('content')
    ...
    <div class="bg-white p-4 rounded shadow mb-6">
        <form action="{{ route('empresas.index') }}" method="GET" class="flex gap-4">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="p-4">
                            ...
                            <div class="text-xs text-gray-500">
                                {{ \Carbon\Carbon::parse($empresa->fecha_creacion)->diffForHumans() }}
                            </div>
                        </td>
                        <td class="p-4">
                            @if($empresa->estado)
                        ...
                        <td class="p-4">
                                <div class="flex gap-2">
                                    ...
                                    @if($empresa->id_estado != 3)
                                        <form action="{{ route('empresas.activar', $empresa->id_empresa) }}" method="POST" class="inline">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
