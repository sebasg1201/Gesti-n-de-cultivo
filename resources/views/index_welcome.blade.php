...
<section class="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
    ...
    <div>
        ...
        <div class="mt-8 flex gap-4">
            <a href="#" class="px-6 py-4 bg-green-500 text-black rounded-xl font-semibold hover:bg-green-600 hover:shadow-lg hover:-translate-y-0.5">
                Comenzar Gratis
            </a>

            <a href="#"
                class="px-6 py-3 border border-gray-200 rounded-xl font-semibold flex items-center gap-3
...
<section class="bg-gray-100 py-20">
    <div class="max-w-7xl mx-auto px-6 text-center">
        ...
        <div class="mt-14 grid gap-6 md:grid-cols-4 text-left">
            {{-- CARD 1 --}}
            <div class="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-md transition hover:shadow-lg hover:-translate-y-0.5">
