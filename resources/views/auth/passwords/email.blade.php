    ...
    <div class="w-full max-w-md bg-white shadow-xl rounded-2xl overflow-hidden">
        ...
        <div class="p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 text-sm mt-2">No te preocupes. Ingresa tu correo electrónico y te enviaremos un enlace para restablecerla.</p>
            </div>

            @if (session('status'))
                <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded relative mb-6 text-sm" role="alert">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="text-sm font-medium text-green-600 hover:text-green-500 flex items-center justify-center gap-2">
