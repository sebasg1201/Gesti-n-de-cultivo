...
@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Registrar Nuevo Proveedor</h2>
                <p class="text-gray-500 text-sm mt-1">Ingrese los datos del proveedor.</p>
            </div>
            ...
            <form action="{{ route('admin.proveedores.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="correo" value="{{ old('correo') }}" placeholder="contacto@proveedor.com"
                    ...
                    <div>
                        ...
                        <input type="text" name="telefono" value="{{ old('telefono') }}" placeholder="Ej: 300 123 4567"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                    </div>
                </div>
