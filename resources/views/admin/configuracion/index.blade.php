...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <!-- Gestión de Estados -->
    <div class="bg-indigo-50 p-6 rounded-xl border border-indigo-100 shadow-sm hover:shadow-md transition">
        <h4 class="font-bold text-lg text-indigo-900 mb-2">Gestión de Estados</h4>
        <p class="text-sm text-indigo-700 mb-4">Administra los estados disponibles en el sistema.</p>
        <a href="{{ route('estados.index') }}" class="inline-block px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm hover:bg-indigo-700">Gestionar Estados</a>
    </div>
