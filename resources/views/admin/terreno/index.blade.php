            ...
            <div class="xl:col-span-1">
                <div class="bg-white rounded-3xl shadow-xl border border-emerald-50 p-6 sticky top-6">
                    ...
                    <form id="terrenoForm" action="{{ route('admin.terrenos.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="space-y-4">
                            <label
                                class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Seleccionar
                                en el Mapa</label>
                            <div id="map"
                                class="w-full h-64 rounded-2xl border-2 border-emerald-100 shadow-inner overflow-hidden">
                            </div>

                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-[10px] font-black text-emerald-500 uppercase tracking-widest mb-1 ml-2">Latitud</label>
                                    <input type="number" step="any" name="latitud" id="latitud"
                                        class="w-full px-4 py-2 rounded-xl bg-emerald-50/30 border-emerald-100 focus:border-emerald-500 focus:ring-emerald-500 text-xs font-mono text-emerald-900 transition-all"
                                        placeholder="0.000000">
                                </div>
                                <div>
                                    <label
                                        class="block text-[10px] font-black text-emerald-500 uppercase tracking-widest mb-1 ml-2">Longitud</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Ubicación
                                Específica</label>
                            <input type="text" name="ubicacion" id="ubicacion"
                                placeholder="Ej. Vereda La Cima, Finca San José..."
                                class="w-full px-4 py-3 rounded-2xl border-emerald-100 focus:border-emerald-500 focus:ring-emerald-500 bg-emerald-50/30 text-sm transition-all"
                                value="{{ old('ubicacion') }}">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Ciudad
                                    / Municipio</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Código
                                Postal</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Ancho
                                    (m)</label>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Alto
                                    (m)</label>
                        ...
                        <div id="estadoContainer" class="hidden animate-in fade-in duration-300">
                            <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Estado del
                                Terreno</label>
