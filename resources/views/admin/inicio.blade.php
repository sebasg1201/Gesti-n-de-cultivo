            ...
            <section class="mb-4">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-emerald-900/20 overflow-hidden">
                    <div class="grid grid-cols-12 gap-4 px-6 py-3 border-b border-gray-100 dark:border-emerald-900/30 bg-gray-50 dark:bg-slate-900/50 text-xs font-semibold text-gray-500 dark:text-emerald-500 uppercase tracking-wider">
                        ...
                        <div class="col-span-2 md:col-span-2">Estado</div>
                        <div class="col-span-4 md:col-span-5">Actividad Reciente</div>
                        ...
                        <div class="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                            ...
                            <div class="col-span-2 md:col-span-2">
                                @if($miembro->is_active)
                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800/40">
                                        <span class="w-1.5 h-1.5 rounded-full bg-green-500"></span> Activo
                                    </span>
                                @else
                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-emerald-400 border border-gray-200 dark:border-emerald-800/40">
                                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400"></span> Descanso
                                    </span>
                                @endif
                            </div>
                            <div class="col-span-4 md:col-span-5 pb-1">
                            ...
                            <div class="col-span-1 hidden md:flex justify-end">
                                <a href="{{ route('admin.usuarios.index', ['worker_id' => $miembro->documento]) }}" 
                                   title="Ver detalles de {{ $miembro->nombre }}"
                                   class="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-800/40 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-sm">
