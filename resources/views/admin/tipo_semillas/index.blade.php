    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-emerald-50 p-6 sticky top-6">
                    ...
                    <div class="relative group mb-6">
                        <label class="block text-xs font-bold text-emerald-700 uppercase tracking-wider mb-2">Buscar
                            variedad técnica</label>
                        <div class="relative">
                            <input type="text" id="catalogSearch" autocomplete="off" placeholder="Ej. Tomate, Café, Maíz..."
            ...
            <div class="xl:col-span-2">
                <div
                    class="bg-white rounded-3xl shadow-xl border border-emerald-50 overflow-hidden min-h-[500px] flex flex-col">
                    <div class="p-6 border-b border-emerald-50 bg-gray-50/50 flex justify-between items-center">
                        ...
                        <div class="bg-white border-2 border-emerald-100 px-6 py-2 rounded-2xl flex items-center gap-3">
                            ...
                            <span
                                class="text-[10px] font-bold text-emerald-400 uppercase tracking-widest leading-none">Especies<br>Activas</span>
                        </div>
                    </div>
                                    ...
                                    <tr class="hover:bg-emerald-50/30 transition-all group">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-10 h-10 bg-emerald-600 rounded-2xl flex items-center justify-center text-white font-black text-base shadow-lg shadow-emerald-100 transform group-hover:rotate-12 transition-transform">
                                                    {{ substr($semilla->nombre_semilla, 0, 1) }}
                                                </div>
                                                <div>
                                                    <span
                                                        class="font-black text-emerald-950 block text-base">{{ $semilla->nombre_semilla }}</span>
                                                    <span
                                                        class="text-[10px] font-bold text-emerald-400 uppercase tracking-wider italic">Catálogo:
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="space-y-1">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        class="text-sm font-bold text-emerald-900">{{ $semilla->tiempo_base_dias }}
                                                        <span class="text-[10px] font-normal text-emerald-500">días ciclo
                                                            base</span></span>
                                                </div>
                                        ...
                                        <td class="px-6 py-4">
                                            <div
                                                ...
                                                <span
                                                    class="text-xs font-black text-emerald-700">{{ $semilla->rendimiento_promedio }}
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <span class="text-2xl font-black text-emerald-950">{{ number_format($semilla->stock_actual ?? 0, 0) }}</span>
