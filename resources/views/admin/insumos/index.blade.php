                    ...
                    <div class="space-y-3">
                        ...
                        <div class="bg-gray-50/50 p-4 rounded-2xl border border-gray-100 flex flex-col items-start gap-1">
                            <div class="flex items-center justify-between w-full mb-1">
                                ...
                                <a href="{{ route('tipo_insumos.index') }}" class="text-emerald-500 hover:text-emerald-600 transition-colors" title="Gestionar Categorías">
...
<script>
    ...
    searchInput.addEventListener('input', function() {
        ...
        debounceTimer = setTimeout(() => {
            fetch(`${window.APP_URL}/insumos/catalog?q=${query}`)
                .then(res => res.json())
                .then(data => {
