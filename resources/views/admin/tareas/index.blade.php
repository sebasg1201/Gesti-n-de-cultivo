                ...
                <div class="p-8 space-y-6 relative z-10">
                    ...
                    <div class="pt-4 flex items-center justify-between">
                        ...
                        <button onclick="openModal('modalRiego')" class="bg-blue-600 text-white p-4 rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
                            <svg class="w-6 h-6 transition-transform duration-500 group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-8 space-y-6 relative z-10">
                    ...
                    <div class="pt-4 flex items-center justify-between">
                        ...
                        <button onclick="openModal('modalInsumo')" class="bg-purple-600 text-white p-4 rounded-2xl hover:bg-purple-700 transition-all shadow-lg shadow-purple-200 group/btn">
                            <svg class="w-6 h-6 transition-transform duration-500 group-hover/btn:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 4v16m8-8H4" />
                            </svg>
                        </button>
                    </div>
                    ...
                    if (data.length === 0) {
                        ...
                        <div class="p-6 text-center">
                            ...
                            <a href="{{ route('admin.usuarios.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-${accentColor}-50 text-${accentColor}-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-${accentColor}-100 transition-all">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
                ...
                .then(items => {
                    ...
                    `;
                        ...
                        if (!hasStock) {
                            ...
                            vendorLink.innerHTML = `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>`;
