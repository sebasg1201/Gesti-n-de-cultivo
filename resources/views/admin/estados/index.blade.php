        ...
        <div class="xl:col-span-3">
            <div class="bg-white rounded-3xl shadow-xl border border-emerald-50 overflow-hidden flex flex-col min-h-[600px]">
                <div class="p-6 border-b border-emerald-50 bg-gray-50/50 flex justify-between items-center">
                    <div>
                        <h3 class="text-xl font-black text-emerald-950">Estados Registrados</h3>
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-emerald-50/50">
                            ...
                            <tr class="hover:bg-emerald-50/20 transition-all group">
                                ...
                                <td class="px-6 py-4">
                                    <span class="font-black text-emerald-950 text-sm">{{ $estado->nombre_estado }}</span>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="3" class="px-6 py-20 text-center text-emerald-300 font-bold italic">No hay estados registrados.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
