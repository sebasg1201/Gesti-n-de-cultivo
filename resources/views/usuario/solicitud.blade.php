            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-8 grid md:grid-cols-2 gap-12">
                    ...
                    <form action="{{ route('solicitud.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <!-- NIT Empresa -->
                        <div>
                            <label for="nit_empresa" class="block text-sm font-medium text-gray-700">NIT Empresa</label>
                            <input type="text" name="nit_empresa" id="nit_empresa" required
                                value="{{ old('nit_empresa') }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm p-3 border @error('nit_empresa') border-red-500 @enderror">
                            @error('nit_empresa') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="comprobante_pago" id="comprobante_pago" required accept="image/*"
                                class="mt-1 block w-full text-sm text-gray-500
                                                        ...
                                                        hover:file:bg-green-100 file:cursor-pointer @error('comprobante_pago') border-red-500 @enderror">
                            @error('comprobante_pago') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
