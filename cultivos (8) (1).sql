...
(11, '834324234', 10, 3, 5, 1, '2026-03-11', '2026-10-04', 'cosechas/F8NLkoXTnf6IvpXrYWiGpkeLnq6mAW4iB7JHcVep.jpg', 15.00);
...
INSERT INTO `entrada_insumo` (`id_entrada`, `id_proveedor`, `id_insumo`, `id_semilla`, `id_empresa`, `cantidad_recibida`, `fecha_entrada`, `precio_unitario`) VALUES
(1, 1, 2, NULL, '834324234', 10.00, '2026-03-10 22:13:45', 400000.00),
(2, 1, NULL, 5, '834324234', 14.00, '2026-03-10 22:15:41', 14000.00);
...
(7, 'jkhgfds', '2026-03-19', 1105461467, 8, 11);
...
(1, 11, 2, 1110722331, 8, 10.00, 0, '2026-03-11', NULL);
...
(5, '834324234', 2, 'Café Arábigo', 210, 'Variedad premium de café con aroma intenso y acidez equilibrada.', 1.50, 14.00);
...
(1104921223, 'usuarios/fxyI259nxaEdNx9meFLTLFkpNIRGXnj7nyy2Z8PX.png', 'julio profe', '3291231212', 'reyesz2803@gmail.com', '$2y$12$NcwOItyOjXK4jwD7js4ri.mghmiFTcxGEzjyPNbzJGOZ6lWJQ7Eou', 'CQAzpRKrWskdTaMqLugO9wPHj8SI5ciVMe7qcgvmJlMAErZHmx7Mz6TuNoYG', 1, 3, '834324234'),
(1105461467, 'usuarios/DKOC3w5ZmiayRnVTgSMffJcI6AQhq9EdKtgtelwj.png', 'sebas', '3176060850', 'gasrciasebastian019@gmail.com', '$2y$12$vrnlIhSsriy/9tEB6L95eOc3SbwfjQhH6/DSuEM6tEPLe.glEsM1.', NULL, 3, 3, '834324234'),
(1110722331, 'usuarios/useOl4EMIIlIsP0f8X6vMaoWPIjhX5Ml9tCDJ2bC.jpg', 'Didier', '3103527239', 'johsn@gmail.com', '$2y$12$4lNRhcjuBmkF25LyFWMLL.k5LlWvmOTnosiRabQoEgyG4ojfgk9am', '', 3, 3, '834324234'),
...
--
ALTER TABLE `cosecha`
  MODIFY `id_cosecha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tipo_salario`
  MODIFY `id_tipo_salario` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `catalogo_insumos`
  ADD CONSTRAINT `catalogo_insumos_ibfk_1` FOREIGN KEY (`id_tipo_insumo`) REFERENCES `tipo_insumo` (`id_tipo_insumo`);
...
--
ALTER TABLE `cultivo`
  ADD CONSTRAINT `cultivo_ibfk_1` FOREIGN KEY (`id_cosecha`) REFERENCES `cosecha` (`id_cosecha`),
  ADD CONSTRAINT `cultivo_ibfk_2` FOREIGN KEY (`documento`) REFERENCES `usuario` (`documento`);
...
--
ALTER TABLE `entrada_insumo`
  ADD CONSTRAINT `entrada_insumo_ibfk_1` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id_proveedor`),
  ADD CONSTRAINT `entrada_insumo_ibfk_2` FOREIGN KEY (`id_insumo`) REFERENCES `insumo` (`ID_insumo`),
  ADD CONSTRAINT `entrada_insumo_ibfk_3` FOREIGN KEY (`id_semilla`) REFERENCES `tipo_semilla` (`id_semilla`);

--
-- Filtros para la tabla `fases_programadas`
--
ALTER TABLE `fases_programadas`
  ADD CONSTRAINT `fases_programadas_ibfk_1` FOREIGN KEY (`documento_trabajador`) REFERENCES `usuario` (`documento`),
  ADD CONSTRAINT `fases_programadas_ibfk_2` FOREIGN KEY (`id_cosecha`) REFERENCES `cosecha` (`id_cosecha`),
  ADD CONSTRAINT `fases_programadas_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`);
...
ALTER TABLE `insumo`
  ...
  ADD CONSTRAINT `insumo_ibfk_2` FOREIGN KEY (`id_catalogo_insumo`) REFERENCES `catalogo_insumos` (`id_catalogo_insumo`),
  ADD CONSTRAINT `insumo_ibfk_3` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id_proveedor`);

--
-- Filtros para la tabla `insumo_cosecha`
--
ALTER TABLE `insumo_cosecha`
  ADD CONSTRAINT `insumo_cosecha_ibfk_1` FOREIGN KEY (`id_cosecha`) REFERENCES `cosecha` (`id_cosecha`),
  ADD CONSTRAINT `insumo_cosecha_ibfk_2` FOREIGN KEY (`id_insumo`) REFERENCES `insumo` (`ID_insumo`),
  ADD CONSTRAINT `insumo_cosecha_ibfk_3` FOREIGN KEY (`documento_trabajador`) REFERENCES `usuario` (`documento`),
  ADD CONSTRAINT `insumo_cosecha_ibfk_4` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`);
...
ALTER TABLE `proveedor`
  ...
  ADD CONSTRAINT `proveedor_ibfk_2` FOREIGN KEY (`ID_insumo`) REFERENCES `insumo` (`ID_insumo`);

--
-- Filtros para la tabla `registro_trabajo`
--
ALTER TABLE `registro_trabajo`
  ADD CONSTRAINT `fk_registro_insumo` FOREIGN KEY (`id_insumo_cosecha`) REFERENCES `insumo_cosecha` (`id_insumo_cosecha`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `riego`
  ...
  ADD CONSTRAINT `riego_ibfk_2` FOREIGN KEY (`id_cosecha`) REFERENCES `cosecha` (`id_cosecha`),
  ADD CONSTRAINT `riego_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`),
  ADD CONSTRAINT `riego_ibfk_4` FOREIGN KEY (`documento_trabajador`) REFERENCES `usuario` (`documento`);

--
-- Filtros para la tabla `salario`
--
ALTER TABLE `salario`
  ADD CONSTRAINT `salario_ibfk_1` FOREIGN KEY (`id_tipo_salario`) REFERENCES `tipo_salario` (`id_tipo_salario`);
...
--
ALTER TABLE `terreno`
  ADD CONSTRAINT `terreno_ibfk_1` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`),
  ADD CONSTRAINT `terreno_ibfk_2` FOREIGN KEY (`id_tipo_suelo`) REFERENCES `tipo_suelo` (`id_tipo_suelo`),
  ADD CONSTRAINT `terreno_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`);
...
ALTER TABLE `tipo_riego`
  ...
  ADD CONSTRAINT `tipo_riego_ibfk_2` FOREIGN KEY (`id_catalogo`) REFERENCES `catalogo_riegos` (`id`);
