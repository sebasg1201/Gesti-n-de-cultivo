...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2026 a las 19:19:30
...
('w6MNdjoO3tr0a59vOa0iVSyqTcgjhfKtqaw5uYoS', 1110722345, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '', 1774389516);
...
(1110722345, 'usuarios/IEJRgrLlnPGGxJcaD5NFbzOnxj7DAVNxZXnoZjTr.jpg', 'Brayan Gutierez', '3029219231', 'sombrahdepaz@gmail.com', '$2y$12$ElMqaOG0Q30Gbt8q2RwPDudpzZPaIlhmEoA4Ldj0WQ6cW6zhcGAiK', 'pZUuhU98VSIyLKsYLEs6psNm5Cpjti0rhFGbSqvw2V4NkJnPNGSiSdRV0j36', 1, 3, '988091212', 1);
...
--
ALTER TABLE `cosecha`
  MODIFY `id_cosecha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `riego`
  MODIFY `id_riego` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
